  ...
  <div class="app-container">
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        <el-input v-model="query.username" clearable size="small" placeholder="用户名搜索" style="width: 200px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.Data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <el-table-column v-if="columns.visible('last_ip')" prop="last_ip" label="登录IP" />
      <el-table-column v-if="columns.visible('addres')" :show-overflow-tooltip="true" prop="addres" label="登录地点" />
        ...
        <template slot-scope="scope">
          ...
          >
            ...
            <div style="text-align: right; margin: 0">
              ...
              <el-button :loading="delLoading" type="primary" size="mini" @click="delMethod(scope.row.username, scope.$index)">确定</el-button>
            </div>
...
// crud交由presenter持有
const defaultCrud = CRUD({ url: 'api/auth/online', title: '在线用户', query: { type: 1 }})
export default {
  name: 'OnlineUser',
